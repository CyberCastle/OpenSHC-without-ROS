...
class Model : public std::enable_shared_from_this<Model> {
  public:
    ...
    /// Accessor for the time delta value which defines the period of a cycle.
    /// @return The time delta value which define the period of a cycle
  ...
  private:
    ...
    double time_delta_; ///< The time period
