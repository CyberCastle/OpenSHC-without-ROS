...
class StateController {
  public:
    ...
    void systemStateCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void robotStateCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void posingModeCallback(const int &input);
    ...
    void poseResetCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void gaitSelectionCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void cruiseControlCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void plannerModeCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void primaryLegSelectionCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void secondaryLegSelectionCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void parameterSelectionCallback(const int &input);
    ...
    /// @see parameters_and_states.h
    void parameterAdjustCallback(const int &input);
  ...
  private:
    ...
    std::shared_ptr<AdmittanceController> admittance_; ///< Pointer to admittance controller object
                                                       ///< Debug class object used for RVIZ visualization
